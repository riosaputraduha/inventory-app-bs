...
@section('content')
    <div class="card">
        ...
        <div class="row">
            <div class="col-lg-12">
                <a href="{{ route('barang.print') }}" class="btn btn-success float-right mt-3 mx-3" data-toggle="tooltip"
                    title="Print">
                    <i class="fas fa-fw fa-print"></i>
                </a>

                <button type="button" class="btn btn-primary float-right mt-3 mx-3" data-toggle="modal"
                ...
                <button type="button" class="btn btn-primary float-right mt-3 mx-3" data-toggle="modal"
                    data-target="#excel_menu">
                    <i class="fas fa-fw fa-upload"></i>
                    Import Excel
                </button>

                <a href="{{ route('excel.barang.export') }}" class="btn btn-success float-right mt-3 mx-3"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a data-id="{{ $commodity->id }}"
                                            ...
                                            data-target="#edit_commodity" data-placement="top" title="Ubah data">
