            ...
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2">
                    <div class="p-4 m-3">
                        ...
                        <h5 class="text-dark font-weight-normal">Aplikasi <span class="font-weight-bold">Inventaris
                                Barang Sekolah</span></h5>
                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-10 background-walk-y position-relative overlay-gradient-bottom"
                    data-background="../assets/img/Humans.png">
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            <div class="mb-5 pb-3">
                                <h1 class="mb-2 display-4 font-weight-bold" id="greetings"></h1>
                                <h5 class="font-weight-normal text-muted-transparent">SD Negeri Grogol Utara 09 Pagi
                                </h5>
                            </div>
                            Jl. Kemandoran I Jl. Inpres No.4, RT.4/RW.5, Grogol Utara, Kec. Kby. Lama, Kota Jakarta
